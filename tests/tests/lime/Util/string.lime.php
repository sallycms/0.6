...
foreach ($testCases as $old => $new) $lime->is(sly_Util_String::strToUpper($old), $new, 'strToUpper()');

// humanImplode()

$lime->is(sly_Util_String::humanImplode(array(), ' und '),        '',              'humanImplode()');
$lime->is(sly_Util_String::humanImplode(array(1), ' und '),       '1',             'humanImplode()');
$lime->is(sly_Util_String::humanImplode(array(1,2), ' und '),     '1 und 2',       'humanImplode()');
$lime->is(sly_Util_String::humanImplode(array(1,2,3), ' und '),   '1, 2 und 3',    'humanImplode()');
$lime->is(sly_Util_String::humanImplode(array(1,2,3,4), ' und '), '1, 2, 3 und 4', 'humanImplode()');

// getRandomString()

$lime->ok(strlen(sly_Util_String::getRandomString(5, 10)) >= 5,  'getRandomString()');
$lime->ok(strlen(sly_Util_String::getRandomString(5, 10)) <= 10, 'getRandomString()');
$lime->ok(strlen(sly_Util_String::getRandomString(5, 5)) == 5,   'getRandomString()');
$lime->ok(strlen(sly_Util_String::getRandomString(10, 5)) >= 5,  'getRandomString()');
$lime->ok(strlen(sly_Util_String::getRandomString(10, 5)) <= 10, 'getRandomString()');

$lime->isnt(sly_Util_String::getRandomString(5, 10), sly_Util_String::getRandomString(5, 10), 'getRandomString()');

// aufräumen

unset($lime, $testCasesTrue, $testCasesFalse, $testCases, $case);
