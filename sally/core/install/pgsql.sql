...
CREATE TABLE sly_file (id SERIAL NOT NULL, re_file_id INT NOT NULL, category_id INT NOT NULL, attributes TEXT NOT NULL, filetype VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) NOT NULL, filesize VARCHAR(255) NOT NULL, width INT NOT NULL, height INT NOT NULL, title VARCHAR(255) NOT NULL, createdate INT NOT NULL, updatedate INT NOT NULL, createuser VARCHAR(255) NOT NULL, updateuser VARCHAR(255) NOT NULL, revision INT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
CREATE INDEX filename ON sly_file (filename);
CREATE TABLE sly_file_category (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, re_id INT NOT NULL, path VARCHAR(255) NOT NULL, attributes TEXT NOT NULL, createdate INT NOT NULL, updatedate INT NOT NULL, createuser VARCHAR(255) NOT NULL, updateuser VARCHAR(255) NOT NULL, revision INT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
CREATE TABLE sly_user (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, login VARCHAR(50) NOT NULL, psw CHAR(40), status BOOLEAN NOT NULL, rights TEXT NOT NULL, lasttrydate INT DEFAULT 0 NOT NULL, timezone VARCHAR(64) NULL, createdate INT NOT NULL, updatedate INT NOT NULL, createuser VARCHAR(255) NOT NULL, updateuser VARCHAR(255) NOT NULL, revision INT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
