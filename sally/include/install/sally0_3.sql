...
CREATE TABLE `sly_article_slice` ( `id` int(11) NOT NULL  auto_increment, `clang` int(11) NOT NULL  , `ctype` int(11) NOT NULL  , `prior` int(5) NOT NULL  ,`slice_id` bigint(20) NOT NULL DEFAULT '0',`article_id` int(11) NOT NULL  , `module` varchar(64) NOT NULL  , `createdate` int(11) NOT NULL  , `updatedate` int(11) NOT NULL  , `createuser` varchar(255) NOT NULL  , `updateuser` varchar(255) NOT NULL  , `revision` int(11) NOT NULL  , PRIMARY KEY (`id`,`article_id`,`module`)) TYPE=MyISAM DEFAULT CHARSET=utf8;
