...
CREATE TABLE `sly_article_slice` ( `id` int(11) NOT NULL  auto_increment, `clang` int(11) NOT NULL  , `ctype` int(11) NOT NULL  , `re_article_slice_id` int(11) NOT NULL  ,`slice_id` bigint(20) NOT NULL DEFAULT '0',`article_id` int(11) NOT NULL  , `module` varchar(64) NOT NULL  , `createdate` int(11) NOT NULL  , `updatedate` int(11) NOT NULL  , `createuser` varchar(255) NOT NULL  , `updateuser` varchar(255) NOT NULL  , `next_article_slice_id` int(11) NULL  , `revision` int(11) NOT NULL  , PRIMARY KEY (`id`,`re_article_slice_id`,`article_id`,`modultyp_id`)) TYPE=MyISAM;
CREATE TABLE `sly_clang` ( `id` int(11) NOT NULL  , `name` varchar(255) NOT NULL  , `revision` int(11) NOT NULL  , PRIMARY KEY (`id`)) TYPE=MyISAM;
...
CREATE TABLE `sly_registry` (`name` varchar(255) NOT NULL UNIQUE , `value` mediumtext ) ENGINE=MyISAM;
