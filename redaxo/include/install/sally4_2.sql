...
CREATE TABLE `rex_user` ( `id` int(11) NOT NULL auto_increment, `name` varchar(255) , `description` text , `login` varchar(50) NOT NULL  , `psw` varchar(50) NOT NULL  , `status` varchar(5) NOT NULL  , `rights` text NOT NULL  , `login_tries` tinyint(4) DEFAULT 0 , `createuser` varchar(255) NOT NULL  , `updateuser` varchar(255) NOT NULL  , `createdate` int(11) NOT NULL , `updatedate` int(11) NOT NULL , `lasttrydate` int(11) DEFAULT 0 , `session_id` varchar(255) , `cookiekey` varchar(255) , `revision` int(11) NOT NULL, PRIMARY KEY(`id`))TYPE=MyISAM;

INSERT INTO `rex_clang` VALUES ('0','deutsch', 0);

CREATE TABLE `rex_slice` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `module_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM;

CREATE TABLE `rex_slice_value` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `rex_registry` (`name` varchar(255) NOT NULL UNIQUE , `value` mediumtext ) ENGINE=MyISAM;
