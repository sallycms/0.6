...
/*abstract*/ class rex_baseManager
{
   ...
   * Konstruktor
   * 
   * @param $i18nPrefix Sprachprefix aller I18N Sprachschl�ssel
   */
  ...
  /**
   * L�scht ein Addon im Filesystem
   * 
   * @param $addonName Name des Addons
   */
  ...
  /**
   * �bersetzen eines Sprachschl�ssels unter Verwendung des Prefixes 
   */
  ...
  /**
   * Findet den Basispfad f�r Media-Dateien
   */
...
class rex_pluginManager extends rex_baseManager
{
   ...
   * 
   * @param $addonName AddOn dem das PlugIn eingef�gt werden soll
  ...
  /*public static*/ function addon2plugin($addonName, $pluginName, $includeFile)
  {
    ...
    // Alle �berbleibenden Keys die ggf. andere Addons beinflussen einflie�en lassen
  ...
  /*protected*/ function apiCall($method, $arguments)
  {
    ...
    // addonName als 1. Parameter einf�gen
