...
"?"))e("#media_method").val("delete_selectedmedia");else return false});e("#rex-form-mediapool-media .sly-button-changecat").click(function(){e("#media_method").val("updatecat_selectedmedia")});e("table.rex-table").delegate("a.sly-delete","click",function(){var b=e(this).parents("table").attr("rel");b||(b="L\u00f6schen?");if(!confirm(b))return false});e("a.sly-blank").attr("target","_blank");e(".rex-widget-medialist.rex-widget-preview").click(a);e(".rex-widget-media.rex-widget-preview, .rex-widget-medialist.rex-widget-preview").bind("mousemove",
a).bind("mouseleave",function(){var b=e(".rex-media-preview",this);b.css("height")!="auto"&&b.slideUp("normal")})});
