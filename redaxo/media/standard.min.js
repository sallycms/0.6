...
b,d){if(b==d||d<0)return a;tmp=a[b];if(b>d)for(index=b;index>d;index--)a[index]=a[index-1];else for(index=b;index<d;index++)a[index]=a[index+1];a[d]=tmp;return a};checkInput=function(a){e("#"+a).attr("checked","checked")};rexShowMediaPreview=function(){var a;a=e(this).hasClass("rex-widget-media")?e("input[type=text]",this).val():e("select option:selected",this).text();var b=e(".rex-media-preview",this),d="../index.php?rex_resize=246a__"+a;if(a&&a.length!=0&&e.inArray(extension,imageExtensions)){a=
e("img",b);if(a.length==0){b.html("<img />");a=e("img",b)}a.attr("src",d);b.css("height")=="auto"&&b.fadeIn("normal")}else b.slideUp("fast")}})(jQuery);
jQuery(function(e){pageloaded=true;e("#rex-form-mediapool-media .sly-button-delete").click(function(){if(confirm(e(this).attr("rel")+"?"))e("#media_method").val("delete_selectedmedia");else return false});e("#rex-form-mediapool-media .sly-button-changecat").click(function(){e("#media_method").val("updatecat_selectedmedia")});e("table.rex-table").delegate("a.sly-delete","click",function(){var a=e(this).parents("table").attr("rel");a||(a="L\u00f6schen?");if(!confirm(a))return false});e("a.sly-blank").attr("target",
"_blank");e(".rex-widget-medialist.rex-widget-preview").click(rexShowMediaPreview);e(".rex-widget-media.rex-widget-preview, .rex-widget-medialist.rex-widget-preview").bind("mousemove",rexShowMediaPreview).bind("mouseleave",function(){var a=e(".rex-media-preview",this);a.css("height")!="auto"&&a.slideUp("normal")});e("#rex-navi-page-mediapool a").click(function(){newPoolWindow("index.php?page=mediapool");return false})});
